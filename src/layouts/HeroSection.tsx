...
import profile from '@assets/henry_png.png';
...
interface HeroSectionProps {
  ...
  backgroundBrightness?: number; // Background brightness (0 = dark overlay, 1 = bright)
    ...
    >
      ...
      >
        ...
        <div className="hero-image-wrapper">
          <img src={profile} alt="Henry Kasulka" className="hero-profile-image" />
        </div>
        ...
        >
          ...
          <Text className="hero-tagline">
            I am a <span className="tag mech">mechanical engineer</span> at{' '}
            <span className="tag stanford">Stanford</span>, passionate about
            building innovative <span className="tag human">human-centered</span> solutions
          </Text>
